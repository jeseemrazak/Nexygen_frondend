    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex justify-between items-center bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Register a new vendor you purchase stock from.</p>
        </div>
        <Link
        ...
        {hasError && (
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-md mb-6">
            <p className="text-sm text-red-700 font-medium">
              Failed to create supplier. Please check your connection and try again.
            </p>
          </div>
        )}
        ...
        <form action={createSupplier} className="space-y-6">
          <div>
            ...
            <input
              ...
              name="name"
              required
              placeholder="e.g., Al Rayan Trading Co."
