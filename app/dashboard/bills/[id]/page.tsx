  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 p-6 font-sans">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <Link href="/dashboard/purchases/invoices" className="text-purple-600 hover:text-purple-800 text-sm font-bold flex items-center gap-1 mb-3 transition-colors">
        ...
        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight flex items-center gap-3 flex-wrap">
          ...
          {bill.cancelledAt ? (
            ...
            <span className={`text-xs font-bold px-3 py-1 rounded-full ring-1 ring-inset ${
              bill.paymentStatus === 'PAID' ? 'bg-purple-50 text-purple-700 ring-purple-600/20' :
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-2 mt-4 text-sm">
          ...
          <p className="flex items-center gap-1.5 text-slate-600 font-medium">
            <span className="text-slate-400">📦</span> <Link href={`/dashboard/purchases/${bill.purchaseOrderId}`} className="text-purple-600 hover:underline font-bold">View Purchase Order #{bill.purchaseOrderId}</Link>
          </p>
          <Link
