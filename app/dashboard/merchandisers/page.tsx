  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setEmail('');
        setPassword('');
        fetchMerchandisers(); // Refresh the list
      } else {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 p-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        ...
        <p className="text-gray-500 mt-1">Add new merchandisers and view your active delivery roster.</p>
      </div>
          ...
          <form onSubmit={handleCreate} className="p-6 space-y-4">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-teal-500 focus:outline-none transition" 
