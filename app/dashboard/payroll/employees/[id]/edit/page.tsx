          ...
          <div className="bg-teal-50 p-6 rounded-md border border-teal-100">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input type="number" step="0.01" name="basicSalary" defaultValue={employee.basicSalary} required className="w-full border border-teal-200 rounded-md px-4 py-3 text-black bg-white" />
              </div>
              <div>
                <label className="block text-sm font-bold text-teal-900 mb-2">Housing Allowance</label>
                <input type="number" step="0.01" name="housingAllowance" defaultValue={employee.housingAllowance} className="w-full border border-teal-200 rounded-md px-4 py-3 text-black bg-white" />
              </div>
              <div>
                <label className="block text-sm font-bold text-teal-900 mb-2">Transportation Allowance</label>
                <input type="number" step="0.01" name="transportationAllowance" defaultValue={employee.transportationAllowance} className="w-full border border-teal-200 rounded-md px-4 py-3 text-black bg-white" />
              </div>
              <div>
                <label className="block text-sm font-bold text-teal-900 mb-2">Telephone Allowance</label>
                <input type="number" step="0.01" name="telephoneAllowance" defaultValue={employee.telephoneAllowance} className="w-full border border-teal-200 rounded-md px-4 py-3 text-black bg-white" />
              </div>
              <div>
                <label className="block text-sm font-bold text-teal-900 mb-2">Other Allowance</label>
                <input type="number" step="0.01" name="otherAllowance" defaultValue={employee.otherAllowance} className="w-full border border-teal-200 rounded-md px-4 py-3 text-black bg-white" />
              </div>
            </div>
          </div>
